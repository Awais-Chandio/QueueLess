...
import { Edit2, Trash2, Hospital, Stethoscope, ChevronLeft, X } from 'lucide-react-native';
import ServiceDoctorAssignment from './ServiceDoctorAssignment';
              ...
              <ScrollView showsVerticalScrollIndicator={false} style={{ maxHeight: '90%' }}>
                {activeTab === 'centers' ? (
                  ...
                  <>
                    ...
                    {/* Doctor assignment — only when editing an existing department */}
                    {!!editingId && <ServiceDoctorAssignment serviceId={editingId} />}
                  </>
                )}
